...
# $Id: GIPv4.py,v 1.1 2006/05/09 07:49:30 avati Exp $
# License: LGPL
...
network, host, and broadcast addresses via psuedo-attributes.
...
if __name__ == "__main__":
	#import os
	#os.system("qaunittest test_ipv4")
	r1 = IPRange("172.22.1.11/24", "172.22.1.21/24")
	r2 = IPRange("172.22.1.21/24", "172.22.1.11/24")
	r3 = IPRange("172.22.1.55/24", "172.22.1.55/24")
