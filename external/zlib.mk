...
zlib.%: LIVE_BUILD_CMD=make -j 8 all $(LIVE_BUILD_ENV) AR="$(CROSS)-ar cr" CFLAGS="-O -fPIC"
zlib.%: LIVE_INSTALL_CMD=make install prefix=$1/usr exec_prefix=$1/usr

zlib.%: PKG_CONFIGURE_CMD=./configure
zlib.%: PKG_BUILD_CMD=make -j 8 all $(LIVE_BUILD_ENV) AR="$(CROSS)-ar cr" CFLAGS="-O -fPIC"
