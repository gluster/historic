...
ncurses.%: LIVE_CONFIGURE_CMD=BUILD_CC=cc $(DEFAULT_LIVE_CONFIGURE_CMD) --with-shared --without-ada --with-build-cc=gcc; sed -i '/cd man/d' Makefile
ncurses.%: NATIVE_CONFIGURE_CMD=$(DEFAULT_NATIVE_CONFIGURE_CMD) --with-shared --without-ada; sed -i '/cd man/d' Makefile
ncurses.%: PKG_CONFIGURE_CMD=BUILD_CC=cc $(DEFAULT_PKG_CONFIGURE_CMD) --with-shared --without-ada; sed -i '/cd man/d' Makefile
