...
rrdtool.%: PKG_BUILD_CMD=make all PERL_MAKE_OPTIONS="CC=$(CROSS)-gcc AR=$(CROSS)-ar FULL_AR=$(CROSS)-ar CCCDLFLAGS=-fPIC LDDLFLAGS=\"-shared -L/opt/gluster/lib\" LDFLAGS=-L/opt/gluster/lib LD=$(CROSS)-gcc OPTIMIZE=-O2"
